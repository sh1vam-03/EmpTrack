            ...
            <nav className="relative z-50 border-b border-white/5 bg-black/50 backdrop-blur-xl sticky top-0 transition-all duration-300">
                <div className="container mx-auto px-6 h-20 flex justify-between items-center">
                    ...
                    <Link href="/" className="flex items-center gap-2 group">
                        ...
                        <span className="text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-blue-200 to-white tracking-tight">EmpTrack</span>
                    </Link>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
                        <div className="col-span-1 md:col-span-1">
                            <Link href="/" className="flex items-center gap-2 mb-6 group">
                                ...
                                <span className="text-2xl font-bold text-white tracking-tight">EmpTrack</span>
                            </Link>
